...
app.post('/api/reloadProjectFileMethods/:projectId/:id', projectsController.reloadProjectFileMethods);
app.post('/api/reloadProject/:projectId/:id', projectsController.reloadProject);
app.post('/api/reloadProjectOrderPeople/:projectId/:id', projectsController.reloadProjectOrderPeople);
...
app.post('/saveDataReload/:id/:nameId', importData.saveDataReload);
