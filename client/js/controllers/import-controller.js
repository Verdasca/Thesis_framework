  ...
  if (regex.test(fileUpload.value.toLowerCase())) {
    if (typeof (FileReader) != "undefined") {
      ...
      reader.onload = function (e) {
        ...
        // dvCSV.appendChild(table);
        $timeout( function(){ refreshProject(); $('#importing').hide(); }, 1000);
      	document.getElementById("importMessage").innerHTML = "Successfully imported alternatives.";
      	document.getElementById("importMessage").style.display = "block";
  ...
  if (regex.test(fileUpload.value.toLowerCase())) {
    if (typeof (FileReader) != "undefined") {
      ...
      reader.onload = function (e) {
        ...
        // dvCSV.appendChild(table);
        $timeout( function(){ refreshProject(); $('#importing').hide(); }, 1000);
      	document.getElementById("importMessage").innerHTML = "Successfully imported performance table.";
      	document.getElementById("importMessage").style.display = "block";
  ...
  if (regex.test(fileUpload.value.toLowerCase())) {
    if (typeof (FileReader) != "undefined") {
      ...
      reader.onload = function (e) {
        ...
        // dvCSV.appendChild(table);
        $timeout( function(){ refreshProject(); $('#importing').hide(); }, 1000);
      	document.getElementById("importMessage").innerHTML = "Successfully imported alternatives and performance table.";
      	document.getElementById("importMessage").style.display = "block";
      	$scope.perfTblImported = true;
      }
      reader.readAsText(fileUpload.files[0]);
  ...
  if (regex.test(fileUpload.value.toLowerCase())) {
    if (typeof (FileReader) != "undefined") {
      ...
      reader.onload = function (e) {
        ...
        // dvCSV.appendChild(table);
        $timeout( function(){ refreshProject(); $('#importing').hide(); }, 1000);
      	document.getElementById("importMessage").innerHTML = "Successfully imported categories.";
      	document.getElementById("importMessage").style.display = "block";
  ...
  if (regex.test(fileUpload.value.toLowerCase())) {
    if (typeof (FileReader) != "undefined") {
      ...
      reader.onload = function (e) {
        ...
        // dvCSV.appendChild(table);
        $timeout( function(){ refreshProject(); $('#importing').hide(); }, 1000);
      	document.getElementById("importMessage").innerHTML = "Successfully imported parameters.";
      	document.getElementById("importMessage").style.display = "block";
      }
      reader.readAsText(fileUpload.files[0]);
    } else {
  ...
  if (regex.test(fileUpload.value.toLowerCase())) {
    if (typeof (FileReader) != "undefined") {
      ...
      reader.onload = function (e) {
        ...
        // dvCSV.appendChild(table);
        $timeout( function(){ refreshProject(); $('#importing').hide(); }, 1000);
      	document.getElementById("importMessage").innerHTML = "Successfully imported profile performance table.";
      	document.getElementById("importMessage").style.display = "block";
